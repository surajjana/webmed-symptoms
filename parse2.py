...
for k in range(1,69):
	...
	data_symptoms = {"request":{"user":{"age":1,"gender":"F","zip":"","vid":"cfd87d3c-3f57-4a36-acdf-11553e89255f"},"locale":"us","bodypartid":k}}
	...
	for i in range(i,c):
		...
		workbook.save('/home/ubuntu/webmed/webmed-symptoms/female_0_2.xls')
		print "Symptom ",i," : ", symptom_name
		url_conditions = "http://symptoms.webmd.com/scapp/SymptomCheckerAPI.svc/conditions"
		data_conditions = {"request":{"user":{"age":1,"gender":"F","zip":"","vid":"cfd87d3c-3f57-4a36-acdf-11553e89255f"},"locale":"us","maxconditions":200,"bodyparts":[{"id":k,"symptoms":[{"id":data_id,"qclss":[{"quals":[]}]}]}]}}
		headers = {'Content-type': 'application/json', 'Accept': 'text/plain'}
...
for k in range(1,69):
	url_symptoms = "http://symptoms.webmd.com/scapp/SymptomCheckerAPI.svc/symptoms"
	data_symptoms = {"request":{"user":{"age":4,"gender":"F","zip":"","vid":"cfd87d3c-3f57-4a36-acdf-11553e89255f"},"locale":"us","bodypartid":k}}
	headers = {'Content-type': 'application/json', 'Accept': 'text/plain'}
	r = requests.post(url_symptoms, data=json.dumps(data_symptoms), headers=headers)
	r.encoding = None
	data = json.loads(r.text.encode(encoding='ISO-8859-1',errors='ignore'))
	...
	for i in range(i,c):
		...
		symptom_name = l_s_nm[i]
		sheet.write(0,i,symptom_name,style)
		workbook.save('/home/ubuntu/webmed/webmed-symptoms/female_3_6.xls')
		print "Symptom ",i," : ", symptom_name
		url_conditions = "http://symptoms.webmd.com/scapp/SymptomCheckerAPI.svc/conditions"
		data_conditions = {"request":{"user":{"age":4,"gender":"F","zip":"","vid":"cfd87d3c-3f57-4a36-acdf-11553e89255f"},"locale":"us","maxconditions":200,"bodyparts":[{"id":k,"symptoms":[{"id":data_id,"qclss":[{"quals":[]}]}]}]}}
		headers = {'Content-type': 'application/json', 'Accept': 'text/plain'}
		r = requests.post(url_conditions, data=json.dumps(data_conditions), headers=headers)
		r.encoding = None
		data = json.loads(r.text.encode(encoding='ISO-8859-1',errors='ignore'))
